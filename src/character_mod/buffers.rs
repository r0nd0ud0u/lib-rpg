...
mod tests {
    ...
    fn unit_buf_kinds_display() {
        ...
        assert_eq!(format!("{}", BufKinds::DamageRxPercent), "Damage received %");
        ...
        assert_eq!(format!("{}", BufKinds::NextHealAtkIsCrit), "Next heal is critical");
        assert_eq!(format!("{}", BufKinds::MultiValue), "Multiplier");
        assert_eq!(format!("{}", BufKinds::ApplyEffectInit), "Effect applications");
        assert_eq!(format!("{}", BufKinds::ChangeByHealValue), "Stat boosted by heal");
        assert_eq!(format!("{}", BufKinds::BoostedByHots), "Boosted by HoTs");
        assert_eq!(format!("{}", BufKinds::ChangeMaxStatByPercentage), "Max stat change %");
        assert_eq!(format!("{}", BufKinds::ChangeMaxStatByValue), "Max stat change");
        assert_eq!(format!("{}", BufKinds::BlockHealAtk), "Heals blocked");
        assert_eq!(format!("{}", BufKinds::ChangeCurrentStatByValue), "Current stat change");
        assert_eq!(format!("{}", BufKinds::ChangeCurrentStatByPercentage), "Current stat change %");
        assert_eq!(format!("{}", BufKinds::RepeatAsManyAsPossible), "Repeat attack");
        assert_eq!(format!("{}", BufKinds::DecreasingRateOnTurn), "Decreasing rate");
        assert_eq!(format!("{}", BufKinds::NbDecreasingByTurn), "Decreasing count");
        assert_eq!(format!("{}", BufKinds::IsDamageTxHealNeedyAlly), "Damage converts to ally heal");
        ...
        assert_eq!(format!("{}", BufKinds::BoostHotsByPercentage), "Boost HoTs %");
        assert_eq!(format!("{}", BufKinds::BoostBufByHotsNumberInPercentage), "HoT stack bonus");
        assert_eq!(format!("{}", BufKinds::PercentageIntoDamages), "Convert heal to damage");
        assert_eq!(format!("{}", BufKinds::NextHealAtkIsCritical), "Next heal is critical");
        assert_eq!(format!("{}", BufKinds::AddAsMuchAsHp), "Overheal stat boost");
        assert_eq!(format!("{}", BufKinds::StreakBreakerCrit), "Streak breaker (crit)");
        assert_eq!(format!("{}", BufKinds::StreakBreakerDodge), "Streak breaker (dodge)");
        assert_eq!(format!("{}", BufKinds::ConditionDamagePrevTurn), "Condition: damage last turn");
